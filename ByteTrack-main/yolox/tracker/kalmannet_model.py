...
KF_F1_DIM = 4
KF_MAIN_INPUT_DIM = 13
KF_INPUT_DIM = KF_F1_DIM + KF_MAIN_INPUT_DIM
KF_STATE_DIM = 8
KF_OBS_DIM = 4
KF_HIDDEN_DIM = 80
...
class KalmanNetNN(nn.Module):
    def __init__(
        ...
        self.f1_dim = KF_F1_DIM
        self.main_input_dim = input_dim - self.f1_dim
    ...
    def forward(self, inputs, hidden_states=None):
        ...
        fused_inputs = torch.cat([f1_embed, main_embed], dim=-1)
